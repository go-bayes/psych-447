...
Q: Is multiple imputation inventing data? 
A: Yes, in the same way that everything in science invents data, namely, through self-conscious, educated guesswork. 

Q: Do I need to multiple-impute missing values?
A: If your data satisfies the assumptions of MAR, you should multiply impute missing values. However, in many cases it makes no practical difference. That said, you cannot know in advance whether your decision not to multiply impute will make a difference, so you should. 

Q: How many missing datasets should I impute? 
A: King suggests five is sufficient. More is even better. Here we used 10. 

Q: How do I handle time series data? 
A: Here we have used the `cs` and `ts` commands in the `Amelia` package

Q: Can I use multiple imputation with Bayesian estimation packages. 
A: Yes, I present code below. The models however mixed poorly. See me if you wish to attempt this. 

Q: Where can I go for help? 
A: See the resources provided at the introduction to this section. 
...
9. You can model outcomes that have an abundance of zeros
10 You an write non-linear models
11. You can simulate data
12. You can perform ANOVA, ANOVCA, and MANOVA in a regression setting
13. You can perform model checks 
14. You can write multilevel models and interpret them. 
15. You understand metanalysis as a form of multi-level modelling
16. You understand the difference between regression for prediction and regression for inference.
17. You understand how to reduce the dimensions of your data.
18.  You understand how to check for counfounding by writing a DAG
19.  You can create a distill website for free on Github
20.  You can multiply impute to handle missingness in your dataset, and you understand why this is a good thing. 

And much much else ... Most of all, you've learned how to continue learning, a skill that will serve you well because the tools of science are constantly improving. 
