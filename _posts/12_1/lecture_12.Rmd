...
Barrett's recall of vitamins example: Does taking vitamins in childhood protect against bladder cancer? If people who have bladder cancer are more likely to recall vitam taking, then this can support the inference that vitamins cause bladder cancer even if the opposite is true:
