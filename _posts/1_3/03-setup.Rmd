...
The `##` makes a heading. We write as ordinary, and we include a link by typing `[here](https://slides.djnavarro.net/starting-rmarkdown/#8)`

Think of rmarkdown as writing in word but without having to use your mouse all the time. 

You can read more about Rmarkdown [here](https://rmarkdown.rstudio.com/).  Figure \@ref(fig:ss) shows Rmarkdown in the rconsole (upper left).
