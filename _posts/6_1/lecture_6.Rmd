...
# average mother height
mh_fake_c <- runif(N,
  min = min(md_df$mother_height_c),
  max = max(md_df$mother_height_c))
...
Much in my approach to teaching simulation owes to Ariel Muldoon. PLease check out Ariel's wonderful R webpage here:
<https://aosmith.rbind.io>

Try out Ariel's tutorial for simulation functions [here](
https://aosmith.shinyapps.io/tutorial_simulation_helper_functions/#section-simulating-datasets)
