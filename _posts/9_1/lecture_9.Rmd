...
Suppose we wanted to assess whether fatigue predicts psychological distress. 
...
Compare models, in this instance we do not need monotonic effects 

```{r}
compare_mo_0 <- add_criterion(mo_0, "loo")
compare_mo_1 <- add_criterion(mo_1, "loo")

compare_mo <-loo_compare(compare_mo_0, compare_mo_1, criterion = "loo")
compare_mo
```


And the posterior predictive checks do not look too different 
