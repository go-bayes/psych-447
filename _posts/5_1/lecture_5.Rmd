...
Regression is a sensible method for guessing
...
In regression, we call the feature of interest in the wold a "parameter." 
...
```{r}
set.seed(123)
ggplot2::qplot(rnorm(100, mean = 170, sd = 20),binwidth = 10)
