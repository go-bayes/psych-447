...
2.  Representativeness
    ...
    > population, hence the implicit assumption in interpreting regression coefficients is that the sample is representative of the population. [@gelman_regression_2020, p.153]\

3.  Linearity\*

    > The most important mathematical assumption of the linear regression
...
4.  Independence of errors
    ...
    > The simple regression model assumes that the errors from the prediction
    > line are independent, an assumption that is violated in time series, spatial, and multilevel settings [@gelman_regression_2020, p.153]
