...
<!-- ```{r} -->
<!-- p_mg2 <-plot(ggeffects::ggpredict(mg2, terms = c( "Household.INC_s[c(-1,0,3)]", "GenCohort[all]"))) -->
<!-- p_mg2 -->
<!-- ``` -->

Uncertainty arises because we only have 17 people in this dataset born after 1996
...
mg2 grealy improves on the BIC performance, indicating that we should prefer this model.
...
Note that we do not include that dataset with fewer cases because this is comparing apples with organges. 
