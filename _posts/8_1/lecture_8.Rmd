...
<aside>
It is fortunate that we live in an ordered universe. Although at the level of particle physics, the universe might be random, at the scale of "medium-sized dry goods", to paraphrase of J L Austen (I think from *Sense and Sensibilia*?)
</aside>
...
<aside>
In Bayesian estimation we often estimate the standard deviation of the mean $\sigma$ , however outside these circles people we describe the same parameter as the variance of the mean, or $\sigma^2$.
