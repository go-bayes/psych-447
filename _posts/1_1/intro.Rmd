...
We're excited to be teaching you R because we believe R will:
...
### GIT how to keep track of everything
...
### We'll be going over Git and GitHub in lab this week. For now, read this:
...
### Final thought: why quantitative psychology has to change (Why can't I use SPSS) by Johannes Karl
...
Next, open a document in Rstudio (File-->New File --Rmarkdown)

Then type away!

```{r rm-gif, echo=F, message=FALSE, warning=FALSE}
knitr::include_graphics("rm.gif")
```
