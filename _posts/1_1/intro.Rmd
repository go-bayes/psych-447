...
title: "Course basics"
description: |
  Goals: (1) Download Rstudio (2) Get Git (3) Essentials of Rmarkdown
author:
...
[Rmarkdown slideshow by D Navarro](https://slides.djnavarro.net/starting-rmarkdown/#8)
...
Think of rmarkdown as writing in word but without having to use your mouse all the time. The really great thing about Rmarkdown is that you can write document and do the analysis in a single stop shop.  Figure \@ref(fig:sf) shows Rmarkdown in the rconsole (upper left).



```{r sf, fig.cap ="\\label{fig:sf}Screenshot of Rmarkdown document (upper left)", echo=F}
knitr::include_graphics("rmark.png")
```
...
## Submit to Blackboard
  ...
  - Either a link to your repository, or the document you created in Rmarkdown (HTML or PDF) 
