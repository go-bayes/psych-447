...
Any readings will be linked in to the lecture page for the reelvant day. If there are no readings that week we will specify: **no readings**
...
These are **due every Friday** during term at midnight. All submissions will be on Blackboard, but you may link a submission to your GitHub page. 
...
Problem sets are also **due every Friday** during term at midnight. Ordinarily we expect you to submit these on your GitHub page, however, we can make special accommodation for those who prefer VUW blackboard (see us).
...
3. **Final project** consisting of:
  ...
  - 1 x 7-minute **video** presentation of your report: 10% (assessment to be discussed in our labs)
