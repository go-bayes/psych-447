...
Perhaps highly religious people are less credulous. Why?


2.  Write report that predicts charitable donations (`CharityDonate`) using no more than five co-variates. Explain your model and results.
...
Consider whether the following graph tells a better story (why, why not?)
