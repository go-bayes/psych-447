...
Use the `patchwork` library to create a figure with two plots on top of each other. Use the `tag_levels` function to index each of the two plots. You may create whatever plot you like. 
