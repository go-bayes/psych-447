...
## Q1  Warm up excercises

###Q1a. Make a new dataframe from the `nz` dataframe. Call it `df`
...
### Q1b. Make all the hours variables into integers 
...
### Q2b Select `Hour.Exercise` and filter only wave 2019
...
## Q2.  Data summaries: What is the difference?
...
## Q3 How many days were there between the date with the highest number of responses and the day with the lowest number of responses? 

Bonus: see if you can also calculate difference in number of responses on the highest and second highest number of responses? Again, make sure to show your work.
...
## Q4. Suppose you were born on Dec 25, 1995 at 5.02:22 am Calculate your age in months on March 20,2021, at 1:22:04pm. (Hint use the `lubridate` package. Look up the `interval` function).
...
## Q5 Create an ordered factor from numeric data
...
1. People who attend church 0 X per month, 
2. People who attend church 1-3 X per month, 
3. People who attend church 4 or more X per month. 
...
## Q6 Using methods described in lecture 4, create a table for average hours of sleep by month in the `nz` dataset
...
## Q7. Graph the average hours of sleep by month including 95% confidence intervals

Briefly explain why some intervals are wider than others. (Hint use the table)
...
Some intervals are wider than others because the number of responses by month varies
...
### Q8. Created a Correlation graph items in the Kessler 6 scale

These are `FeelHopeless,FeelDepressed,FeelRestless,EverythingIsEffort,FeelWorthless,FeelNervous`

What do you find most intersting about this plot? 
...
## Q9 Create a blank `papaja` report with your name, affiliation, contributors and r packages used in your analysis
